...
class SagePay {
	...
	protected $encryptPassword = "Form Integration Encryption Password";
	...
	public function getCrypt() {
			...
			$datapadded = $this->pkcs5_pad($cryptString,16);
			$cryptpadded1 = $this->encryptAndEncode($datapadded);
			return $cryptpadded1;
	...
	protected function decodeAndDecrypt($strIn) {
		...
		$iv = $key;
	  	...
	  	$encrypted = openssl_encrypt($strIn, 'aes-256-cbc', $key, 0, $iv);
